...
class MainActivity : AppCompatActivity() {
    ...
    val pickButton by lazy { findViewById<Button>(R.id.pick_button) }
    val imageView by lazy { findViewById<ImageView>(R.id.image_view) }
    val cameraButton by lazy { findViewById<Button>(R.id.open_camera_button) }
